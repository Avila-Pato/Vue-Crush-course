            ...
            <div class="space-y-4">
              <div class="space-y-2">
                ...
                <h1 class="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
                  <span class="sm:text-6xl"> </span> Wireless Bluetooth Earbuds
                  <span
              ...
              <p class="text-base text-gray-200 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                Immerse yourself in superior audio quality with the StellarGlo Wireless Bluetooth
                Earbuds. These sleek and lightweight earbuds deliver crystal-clear sound and rich
                bass.
              </p>
            </div>
            ...
            <div class="flex space-x-4 items-center text-white">
              ...
              <a href="" target="_blank">
                <img
                  ...
                  class="w-32 h-8 md:w-48 md:h-12 lg:w-64 lg:h-16"
                  width="250"
                  height="54"
                />
              </a>
